...
class StorageCoreArgument : ArgumentType<ResourceLocation> {
    ...
    override fun <S : Any> listSuggestions(context: CommandContext<S>, builder: SuggestionsBuilder): CompletableFuture<Suggestions> {
        if (context.source is SharedSuggestionProvider) {
            return SharedSuggestionProvider.suggestResource(Main.registry.getRequiredCores(), builder)
        }
    ...
    companion object {
        fun storageCore() = StorageCoreArgument()
    }
}